> Historical implementation record, preserved on 16 September 2026. Some statements describe earlier versions. For current priorities, see [the roadmap](ROADMAP.md); for supported behaviour, consult current source and implementation status.
