...
#
# That page has two authors. This script owns everything above "## The host
# agent" and emits an empty placeholder below it; scripts/agent-lifecycle.sh
# fills in what lies between the sentinels there. Running this one alone
# therefore blanks the agent section — which is why the placeholder says what to
# run, rather than leaving a reader to wonder whether nothing was measured or
# nothing worked. The weekly workflow runs both, in this order.
